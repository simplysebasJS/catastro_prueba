...
import TableLands from '../../src/components/TableLands';
import { useCreateLand } from "../../src/graphql/lands/landsHooks";
...
export default function index() {
  ...
  const addLand = useCreateLand();

  const handleSubmit = () => {
    addLand({ variables: land });
  }
